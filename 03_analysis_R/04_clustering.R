...
#   Figure 14      Hierarchical clustering of high-intensity projection targets
#   Figure 15      High regional overlap but low cluster agreement between conditions
#   Figure 22      Sex-specific hierarchical clustering of projection patterns
#   Figure 23      Adjusted Rand Index and Jaccard Index of the top 40 clusters
#
